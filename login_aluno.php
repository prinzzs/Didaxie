    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result->num_rows == 1) {
            ...
            if (password_verify($senha, $user['senha'])) {
                ...
                // Redirecionar para jogo1.html
                header("Location: jogo1.html");
                exit();
            } else {
...
<body>
    <div class="container">
        ...
        <form method="POST" action="login_aluno.php" id="loginForm">
        ...
        <p class="login-link" onclick="window.location.href='cadastro_aluno.php'">NÃO TENHO UMA CONTA</p>
    </div>
